...
def CNNRNN(x, y, bs, turns, keep_prob,
           rnn_hiddens, filter_size, num_filters,
           gating, batch_norm, num_layers, masks, memory_rnn_type=None):
    ...
    rnn_output = build_RNN(sentCNNs, bs, turns, rnn_hiddens, batch_norm, 'context_RNN',
                           'Bi-LSTM', keep_prob, num_layers)  # Sentence context
